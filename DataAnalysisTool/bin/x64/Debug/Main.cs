...
namespace DataAnalysisTool
{
    public partial class Main : Form
    {
        ...
        // *** Failmode analysis ***
        private void topFailModeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            // Return if no any data
        ...
        private void topFailParetoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            // Return if no any data
            if (tblData.Rows.Count == 0 || _DataParse.FailedDevice == 0)
            {
        ...
        // *** KGU verify
        private void kGUToolStripMenuItem_Click(object sender, EventArgs e)
        {
            #region *** Variable Define ***
